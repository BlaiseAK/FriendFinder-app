...
module.exports = function(app) {
    ...
    app.post("/api/funbuddies", function(req, res){
        ...
        console.log("the newBuddyScores: "+ newBuddyScores);
        ...
        for (var i = 0; i<potentialsDiffArry.length; i++) {
            ...
            if (potentialsDiffArry[i]<potentialsDiffArry[i+1]){
